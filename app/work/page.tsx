...
export const metadata: Metadata = {
  title: 'Portfolio',
  description:
    'Azam - Selected work and case studies showcasing full stack development, DevOps, and AI integration projects.',
  openGraph: {
        ...
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-background">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty animate-slide-up" style={{ animationDelay: '100ms' }}>
              Case studies showcasing full stack development, infrastructure, and AI integration for production systems.
              </p>
            </div>
          </div>
        </section>
